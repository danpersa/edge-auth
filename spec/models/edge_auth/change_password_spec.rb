...
describe EdgeAuth::ChangePassword do
  ...
  it 'should create a new valid instance given valid attributes' do
    change_password = EdgeAuth::ChangePassword.new(@attr)
  ...
  it_should_behave_like 'password validation' do
    let(:action) do
      @valid_object = EdgeAuth::ChangePassword.new(@attr)
  ...
  describe 'failure' do
    ...
    it 'should not be valid without an old_password' do
      change_password = EdgeAuth::ChangePassword.new(@attr.merge(:old_password => ''))
      change_password.should_not be_valid 
    end

    it 'should not be valid with wrong old_password' do
      change_password = EdgeAuth::ChangePassword.new(@attr.merge(:old_password => 'abc'))
      change_password.user_id = @user.id
      change_password.should_not be_valid
